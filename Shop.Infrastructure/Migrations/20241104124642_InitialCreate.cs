    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product_Vouchers", x => new { x.ProductId, x.VoucherId });
                    table.ForeignKey(
                        name: "FK_Product_Vouchers_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_Vouchers_Vouchers_VoucherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_Vouchers_VoucherId",
