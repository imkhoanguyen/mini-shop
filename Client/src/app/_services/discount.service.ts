...
export class DiscountService {
  ...
  getDiscountsPagedList(
    params: any
  ): Observable<PaginatedResult<DiscountDto[]>> {
    ...
    return this.http
      .get<DiscountDto[]>(this.apiUrl + '/Discount', {
        params: httpParams,
        observe: 'response',
      })
      .pipe(
  ...
  updateDiscount(discount: DiscountUpdate): Observable<DiscountDto> {
    return this.http.put<DiscountDto>(
      `${this.apiUrl}/Discount/Update`,
      discount
    );
  }
  ...
  getDiscountByCode(code: string) {
    return this.http.get<DiscountDto>(`${this.apiUrl}/discount/code`, {
      observe: 'response',
      params: { code },
    });
  }
